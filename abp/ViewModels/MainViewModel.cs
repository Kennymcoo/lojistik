    ...
    internal List<string> ExecuteColumn(Columns column, int[] textboxValues, int? overrideFirstTableIndex = null, int? overrideSecondTableIndex = null)
    {
        ...
        switch (column)
        {
            ...
            case Columns.A:
                ...
                secondTable = [3, 0, 4, 10, 20, 35, 56];
                break;

            case Columns.B:
                firstTable = [8, 0, 6, 21, 56];
                secondTable = [2, 0, 3, 6, 10, 15, 21, 28, 36];
                isForBandD = true;
                break;

            case Columns.C:
                firstTable = [0, 0, 5, 15, 35, 70];
                secondTable = [1, 0, 2, 3, 4, 5, 6, 7, 8, 9 ];
                break;

            case Columns.D:
                firstTable = [ 3, 0, 4, 10, 20, 35, 56 ];
            ...
            case Columns.E:
                ...
                secondTable = [ 8, 0, 6, 21, 56 ];
                break;
                
            case Columns.F:
                firstTable = [ 1, 0, 2, 3, 4, 5, 6, 7, 8, 9 ];
                secondTable = [ 0, 0, 5, 15, 35, 70];
                break;
